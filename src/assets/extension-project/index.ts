...
export { default as Apresentacao } from './apresentacao.pdf';
export { default as Entrevista1 } from './entrevista1.mp4';
export { default as Entrevista2 } from './entrevista2.mp4';
export { default as Explicacao } from './explicacao.mp4';
